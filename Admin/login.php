...
$log=mysqli_query($con,"insert into adminlog(uid,username,userip,status) values('".$_SESSION['id']."','".$_SESSION['login']."','$uip','$status')");
...
$uip=$_SERVER['REMOTE_ADDR'];
$status=0;
mysqli_query($con,"insert into adminlog(username,userip,status) values('".$_SESSION['login']."','$uip','$status')");
