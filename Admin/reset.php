...
if(isset($_POST['submit'])){
    ...
    $ret=mysqli_query($con,"SELECT * FROM admin_table WHERE nidNo='".$_POST['nidNo']."' and dateOfBirth='".$_POST['dateOfBirth']."' and phoneNo='".$_POST['phoneNo']."' ");
    $num=mysqli_fetch_array($ret);
    if($num>0){
        $ret1=mysqli_query($con,"update admin_table set password='$password' where nidNo ='$nidNo' ");
